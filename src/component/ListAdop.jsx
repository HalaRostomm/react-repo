...
const handleChatClick = (postOwnerId, type, petId) => {
  ...
  if (loading)
    return <p style={{ textAlign: "center", fontFamily: "'Poppins', sans-serif" }}>⏳ Loading adoption posts...</p>;
  if (error)
    return (
  ...
  if (posts.length === 0)
    return (
      <p style={{ textAlign: "center", fontFamily: "'Poppins', sans-serif" }}>📭 No adoption posts available.</p>
    );
